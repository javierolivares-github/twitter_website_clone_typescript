...
/**The **OfficialIcon** component renders an icon with the shape of a badge. */
export default {
  title: 'Atoms/Icons/OfficialIcon',
...
/** This is the default version of the **OfficialIcon** component:*/
