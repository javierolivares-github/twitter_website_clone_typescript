...
/**The **SharedIcon** component renders an icon that represent share content. */
export default {
  title: 'Atoms/Icons/SharedIcon',
...
/** This is the default version of the **SharedIcon** component:*/
